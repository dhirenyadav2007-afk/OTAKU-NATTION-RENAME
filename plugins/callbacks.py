        ...
        if data == "home":
            await query.message.edit_text(
                ...
                reply_markup=InlineKeyboardMarkup([
                    ...
                    InlineKeyboardButton("💳", callback_data='seeplan'),
                    ...
                    [InlineKeyboardButton('• ᴜᴘᴅᴀᴛᴇs', url='https://t.me/BotifyX_Pro_Botz'), InlineKeyboardButton('sᴜᴘᴘᴏʀᴛ •', url='https://t.me/BotifyX_support')],
                    [InlineKeyboardButton('• ᴀʙᴏᴜᴛ', callback_data='about'), InlineKeyboardButton('Dᴇᴠᴇʟᴏᴘᴇʀ •', url='https://t.me/Akuma_Rei_Kami')]
                ])
            )
        elif data == "caption":
            await query.message.edit_text(
                ...
                disable_web_page_preview=True,
                reply_markup=InlineKeyboardMarkup([
                    [InlineKeyboardButton("• sᴜᴘᴘᴏʀᴛ", url='https://t.me/BotifyX_support'), InlineKeyboardButton("ʙᴀᴄᴋ •", callback_data="help")]
                ])
            )
        elif data == "help":
            await query.message.edit_text(
                ...
                reply_markup=InlineKeyboardMarkup([
                    ...
                    [InlineKeyboardButton('• ᴍᴇᴛᴀᴅᴀᴛᴀ', callback_data='meta'), InlineKeyboardButton(' • ᴘʀᴇᴍɪᴜᴍ', callback_data='premium')],
            ...
            await query.message.edit_text(
                ...
                disable_web_page_preview=True,
                reply_markup=InlineKeyboardMarkup([
                    [InlineKeyboardButton("• ʙᴀᴄᴋ", callback_data="help"), InlineKeyboardButton("ʙᴜʏ ᴘʀᴇᴍɪᴜᴍ •", url='https://t.me/ITSANIMEN')]
                ])
            )
            ...
            try:
                api_data_1 = await client.listen(query.message.chat.id, filters=filters.text, timeout=300)
                await msg.delete()
                api_link_1_s = api_data_1.text.strip()

                msg = await api_data_1.reply("<b>ꜱᴇɴᴅ ᴠᴇʀɪꜰʏ 𝟷 ꜱʜᴏʀᴛɴᴇʀ ᴀᴘɪ ᴋᴇʏ:\n\nʟɪᴋᴇ - 064438447747gdg4\n\n/cancel ᴛᴏ ᴄᴀɴᴄᴇʟ</b>")
                verify_data_1 = await client.listen(query.message.chat.id, filters=filters.text, timeout=300)
                await msg.delete()
            ...
            try:
                api_data_2 = await client.listen(query.message.chat.id, filters=filters.text, timeout=300)
                await msg.delete()
                api_link_2_s = api_data_2.text.strip()
                
                msg = await api_data_2.reply("<b>ꜱᴇɴᴅ ᴠᴇʀɪꜰʏ 𝟸 ꜱʜᴏʀᴛɴᴇʀ ᴀᴘɪ ᴋᴇʏ:\n\nʟɪᴋᴇ - 064438447747gdg4\n\n/cancel ᴛᴏ ᴄᴀɴᴄᴇʟ</b>")
                verify_data_2 = await client.listen(query.message.chat.id, filters=filters.text, timeout=300)
                await msg.delete()
